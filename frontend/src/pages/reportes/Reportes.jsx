...
const Reportes = () => {
    ...
    const handleDescargarReporteSubastas = async () => {
        ...
        await descargarReporte('subastas', () => descargarReporteSubastas(fechaInicioSubasta, fechaFinSubasta));
    };
    ...
    const handleDescargarReportePacking = async () => {
        ...
        await descargarReporte('packing', () => descargarReportePacking(fechaInicioPacking, fechaFinPacking));
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">
                                Ventas: empresa, tipo de fruta, ganadores, ofertas y precios
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1">F. Inicio</label>
                            <input
                                type="date"
                                value={fechaInicioSubasta}
                                onChange={(e) => setFechaInicioSubasta(e.target.value)}
                                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1">F. Fin</label>
                            <input
                                type="date"
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">
                                Producción: desglose diario por empresa, tipo de fruta y totales
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input
                                type="date"
                                value={fechaInicioPacking}
                                onChange={(e) => setFechaInicioPacking(e.target.value)}
                        ...
                        <div>
                            ...
                            <input
                                type="date"
                                value={fechaFinPacking}
                                onChange={(e) => setFechaFinPacking(e.target.value)}
                                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                            />
                        </div>
                    </div>
            ...
            {/* Mensajes de estado */}
            {mensaje && (
                <div className={`p-4 rounded-lg border flex items-start gap-3 ${mensaje.tipo === 'success' ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-800'}`}>
